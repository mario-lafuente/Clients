...
add_action( 'save_post', 'woocommerce_product_custom_fields_save2' );
//1 cron_update( ) {
...
function regular_Price(   ) {
  ...
  woocommerce_wp_text_input(
    array(
      ...
      'id'          => '_number_field_sale[' .  $post->ID . ']',
      'label'       => __( 'sales en dolares', 'woocommerce' ),
      'desc_tip'    => 'true',
      'description' => __( 'ponga el precio en dolares del producto', 'woocommerce' ),
      'value'       => get_post_meta(  $post->ID, '_number_field_sale', true ),
      'custom_attributes' => array(
              'step' 	=> 'any',
              'min'	=> '0'
            )
  ...
  echo '
<style type="text/css">
  table.variations{float:left;background-color:red;width:50%}#general_product_data>.options_group:before{content:"  ";display:block;width:100%;height:80px;background-color:#d0d0d0}.woocommerce_options_panel .options_group{position:relative}#general_product_data p.form-field{margin:5px 20px 0 0;top:0;padding:10px!important}.woocommerce_options_panel label{padding:0;margin:0}.dolarRate{position:absolute;width:15%;background-color:#fdff97;top:0;padding:10px;margin:10px;left:30px}.form-row.form-row-first,.form-row.form-row-last{width:40%}.divRegularPrice,.divSalesrPrice{width:20%!important;top:16px;padding:5px;position:absolute;background-color:#fff;margin:10px}.divRegularPrice{left:30%}.divSalesrPrice{left:55%}.divchangeDolar{width:15%;position:absolute;background-color:#fff;top:0;left:80%;padding:10px;margin:10px}.form-row.form-row-full{width:100%}
  </style>
  ';
...
function woocommerce_product_custom_fields_save2( ) {
                ...
                update_post_meta( $post_id, '_number_field_sale', esc_attr( $Dolar_number_field_sale ) );
                    ...
                    if( ! empty( $Dolar_number_field ) ) {
                     ...
                     $regular_price = $Dolar_number_field * $rate;
               		   $regular_price = round($regular_price);  // // Round up the price in colon
...
function variation_settings_fields( $loop, $variation_data, $variation ) {
 ...
 //gnc_woo_cron_update2( );
  ...
  echo '
  <style type="text/css">
  table.variations{float:left;background-color:red;width:50%}.variable_pricing:before{content:"  ";display:block;width:100%;height:80px;background-color:#d0d0d0}.data{position:relative}.dolarRate{position:absolute;width:15%;background-color:#fdff97;top:148px;padding:10px;margin:10px}.form-row.form-row-first,.form-row.form-row-last{width:40%}.divRegularPrice,.divSalesrPrice{width:20%!important;padding:5px;position:absolute;background-color:#fff;top:148px;margin:10px}.divRegularPrice{left:30%}.divSalesrPrice{left:55%}.divchangeDolar{width:10%;position:absolute;background-color:#fff;top:148px;left:78%;padding:10px;margin:10px}p.form-field{float:left;min-height:20px;margin:5px 20px 0 0}.form-row.form-row-full{width:100%}
  </style>
  ';
...
} // Number Field Dolares regular price end/
